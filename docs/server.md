<h2>[원본 링크] https://ksh24865.github.io/server</h2>
...
<div style="flex: 3;">
  ...
  <ul>
    ...
    <li>API 서버 및 분산 데이터 처리 시스템의 단위별 캐싱을 통해 <strong>대시보드 조회 성능을 80% 이상 개선</strong></li>
  </ul>
  ...
  <ul>
    ...
    <li>커스텀한 분석 리포트를 생성하는 서비스 구현</li>
  ...
  <ul>
    ...
    <li>Spark 및 Trino 최적화를 통해 처리 성능 향상 및 <strong>20% 이상의 데이터 처리 비용 절감</strong></li>
